...
import com.aspirephile.studytimer.session.SessionComplete;
import com.aspirephile.studytimer.session.setup.SessionSetup;
import com.aspirephile.studytimer.timming.Time;
import com.aspirephile.studytimer.util.SystemUiHider;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.mi_preferences:
                i = new Intent("com.aspirephile.studytimer.PREFERENCES");
